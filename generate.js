...
(function(){
  ...
  window.vhCopyResult=function(){
    ...
    var text=v+(l?' \u2013 '+l:'')+(s?'\n'+s:'');
    if(navigator.clipboard&&text.trim()){navigator.clipboard.writeText(text).then(function(){var b=document.getElementById('vhCopyBtn');if(b){b.innerHTML='<span class="calc-action-icon">\u2713</span> Copied!';setTimeout(function(){b.innerHTML='<span class="calc-action-icon">\\u{1F4CB}</span> Copy';},2000);}});}
  };
