...
<div class="calc-page-hero-inner">
<div class="calc-page-hero-left">
<span class="calc-page-hero-badge">&#128218; ${blogPosts.length}+ Expert Health Articles</span>
<h1 class="calc-page-hero-title">Health &amp; Wellness Blog</h1>
<p class="calc-page-hero-sub">Evidence-based guides on nutrition, fitness, mental health, and more — written by experts, free for everyone.</p>
<div class="blog-hero-search-wrap" style="margin-bottom:24px;">
<div class="calc-index-search-bar" style="max-width:480px;">
<svg viewBox="0 0 20 20" fill="none"><circle cx="8" cy="8" r="6" stroke="currentColor" stroke-width="2"/><path d="M13 13l5 5" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
<input type="text" id="blogHeroInput" placeholder="Search ${blogPosts.length}+ articles..." oninput="blogHeroSearch(this.value)" onkeydown="if(event.key==='Enter'){openBlogSearch(this.value)}" autocomplete="off">
<button class="calc-index-btn-primary" style="padding:8px 18px;font-size:0.875rem;white-space:nowrap;" onclick="openBlogSearch(document.getElementById('blogHeroInput').value)">Search</button>
</div>
<div class="blog-hero-suggestions" id="blogHeroSugg"></div>
</div>
<div class="calc-index-hero-btns" style="margin-bottom:28px;">
<a href="#all-articles" class="calc-index-btn-primary">&#128214; Browse Articles</a>
<a href="#all-articles" class="calc-index-btn-outline">&#128202; Explore Topics</a>
<a href="/tools/" class="calc-index-btn-outline">&#9889; Try Tools</a>
</div>
<div class="calc-index-hero-stats">
<div class="calc-index-stat"><strong>${blogPosts.length}+</strong><span>Articles</span></div>
<div class="calc-index-stat"><strong>${blogCategories.length}</strong><span>Categories</span></div>
<div class="calc-index-stat"><strong>Expert</strong><span>Reviewed</span></div>
<div class="calc-index-stat"><strong>Free</strong><span>Always</span></div>
</div>
</div>
<div class="calc-page-hero-right">
<svg viewBox="0 0 480 320" class="calc-hero-svg" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Health blog articles illustration">
<rect width="480" height="320" rx="20" fill="#e8f5e9"/>
<rect x="16" y="16" width="448" height="288" rx="16" fill="#ffffff" opacity="0.6"/>
<!-- Main article card -->
<rect x="30" y="28" width="280" height="176" rx="12" fill="#1f5f3a"/>
<rect x="30" y="28" width="280" height="80" rx="12" fill="url(#blogGrad1)"/>
<text x="46" y="74" font-family="Georgia,serif" font-size="13" font-weight="700" fill="#ffffff" opacity="0.9">NUTRITION</text>
<rect x="46" y="90" width="200" height="10" rx="4" fill="rgba(255,255,255,0.9)"/>
<rect x="46" y="108" width="240" height="8" rx="4" fill="rgba(255,255,255,0.6)"/>
<rect x="46" y="122" width="180" height="8" rx="4" fill="rgba(255,255,255,0.6)"/>
<rect x="46" y="144" width="60" height="22" rx="11" fill="rgba(255,255,255,0.2)" stroke="rgba(255,255,255,0.4)" stroke-width="1"/>
<text x="58" y="159" font-family="Arial,sans-serif" font-size="10" fill="rgba(255,255,255,0.85)">5 min read</text>
<rect x="130" y="144" width="80" height="22" rx="11" fill="#52b788"/>
<text x="150" y="159" font-family="Arial,sans-serif" font-size="10" font-weight="700" fill="#fff">Read Now</text>
<!-- Side article cards -->
<rect x="322" y="28" width="134" height="80" rx="10" fill="#f0faf5" stroke="#c8e6c9" stroke-width="1"/>
<rect x="334" y="40" width="60" height="8" rx="3" fill="#1b4332"/>
<rect x="334" y="54" width="100" height="6" rx="3" fill="#9ca3af"/>
<rect x="334" y="66" width="80" height="6" rx="3" fill="#9ca3af"/>
<rect x="334" y="82" width="45" height="16" rx="8" fill="#d1fae5"/>
<text x="340" y="93" font-family="Arial,sans-serif" font-size="9" fill="#1b4332">FITNESS</text>
<rect x="322" y="120" width="134" height="80" rx="10" fill="#f0faf5" stroke="#c8e6c9" stroke-width="1"/>
<rect x="334" y="132" width="70" height="8" rx="3" fill="#1b4332"/>
<rect x="334" y="146" width="100" height="6" rx="3" fill="#9ca3af"/>
<rect x="334" y="158" width="75" height="6" rx="3" fill="#9ca3af"/>
<rect x="334" y="174" width="55" height="16" rx="8" fill="#d1fae5"/>
<text x="340" y="185" font-family="Arial,sans-serif" font-size="9" fill="#1b4332">WELLNESS</text>
<!-- Bottom row cards -->
<rect x="30" y="216" width="126" height="76" rx="10" fill="#f0faf5" stroke="#c8e6c9" stroke-width="1"/>
<rect x="42" y="228" width="80" height="7" rx="3" fill="#1b4332"/>
<rect x="42" y="242" width="100" height="5" rx="3" fill="#9ca3af"/>
<rect x="42" y="253" width="70" height="5" rx="3" fill="#9ca3af"/>
<rect x="42" y="268" width="40" height="14" rx="7" fill="#d1fae5"/>
<text x="47" y="278" font-family="Arial,sans-serif" font-size="8" fill="#1b4332">SLEEP</text>
<rect x="168" y="216" width="128" height="76" rx="10" fill="#f0faf5" stroke="#c8e6c9" stroke-width="1"/>
<rect x="180" y="228" width="85" height="7" rx="3" fill="#1b4332"/>
<rect x="180" y="242" width="100" height="5" rx="3" fill="#9ca3af"/>
<rect x="180" y="253" width="65" height="5" rx="3" fill="#9ca3af"/>
<rect x="180" y="268" width="52" height="14" rx="7" fill="#d1fae5"/>
<text x="185" y="278" font-family="Arial,sans-serif" font-size="8" fill="#1b4332">MINDSET</text>
<rect x="308" y="216" width="148" height="76" rx="10" fill="#1f5f3a"/>
<text x="382" y="252" font-family="Georgia,serif" font-size="28" font-weight="700" fill="#52b788" text-anchor="middle">${blogPosts.length}+</text>
<text x="382" y="270" font-family="Arial,sans-serif" font-size="11" fill="rgba(255,255,255,0.8)" text-anchor="middle">Articles</text>
<text x="382" y="284" font-family="Arial,sans-serif" font-size="9" fill="rgba(255,255,255,0.6)" text-anchor="middle">Free &amp; Expert-Reviewed</text>
<defs>
<linearGradient id="blogGrad1" x1="0" y1="0" x2="1" y2="1">
<stop offset="0%" stop-color="#1a4731"/>
<stop offset="100%" stop-color="#2f7a4d"/>
</linearGradient>
</defs>
</svg>
</div>
