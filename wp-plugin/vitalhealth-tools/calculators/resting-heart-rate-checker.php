...
$uid = 'vht_resting_heart_rate_checker_' . uniqid();
?>
<div class="vht-calculator" id="<?php echo esc_attr($uid); ?>" data-calculator="resting-heart-rate-checker">
    <h3 class="vht-calc-title"><?php esc_html_e('Resting Heart Rate Checker', 'vitalhealth-tools'); ?></h3>
    <form class="vht-calc-form" onsubmit="return false;">
        <div class="vht-field">
            ...
            <input type="number" id="<?php echo esc_attr($uid); ?>_resting_hr" name="resting_hr" placeholder="<?php esc_attr_e('e.g. 65', 'vitalhealth-tools'); ?>" min="20" max="150">
        </div>
        <div class="vht-field">
        ...
        <button type="button" class="vht-btn-calculate" onclick="vht_calc_resting_heart_rate_checker('<?php echo esc_js($uid); ?>')"><?php esc_html_e('Calculate', 'vitalhealth-tools'); ?></button>
    </form>
