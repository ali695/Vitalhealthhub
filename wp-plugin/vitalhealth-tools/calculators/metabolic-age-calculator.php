...
$uid = 'vht_metabolic_age_calculator_' . uniqid();
?>
<div class="vht-calculator" id="<?php echo esc_attr($uid); ?>" data-calculator="metabolic-age-calculator">
    <h3 class="vht-calc-title"><?php esc_html_e('Metabolic Age Calculator', 'vitalhealth-tools'); ?></h3>
    <form class="vht-calc-form" onsubmit="return false;">
        <div class="vht-field">
            ...
            <input type="number" id="<?php echo esc_attr($uid); ?>_weight_kg" name="weight_kg" placeholder="<?php esc_attr_e('e.g. 75', 'vitalhealth-tools'); ?>" min="30" max="200">
        </div>
        <div class="vht-field">
            <label for="<?php echo esc_attr($uid); ?>_height_cm"><?php esc_html_e('Height (cm)', 'vitalhealth-tools'); ?></label>
            <input type="number" id="<?php echo esc_attr($uid); ?>_height_cm" name="height_cm" placeholder="<?php esc_attr_e('e.g. 175', 'vitalhealth-tools'); ?>" min="100" max="250">
        </div>
        <div class="vht-field">
            <label for="<?php echo esc_attr($uid); ?>_age"><?php esc_html_e('Age (years)', 'vitalhealth-tools'); ?></label>
            <input type="number" id="<?php echo esc_attr($uid); ?>_age" name="age" placeholder="<?php esc_attr_e('e.g. 35', 'vitalhealth-tools'); ?>" min="18" max="90">
        </div>
        <div class="vht-field">
        ...
        <button type="button" class="vht-btn-calculate" onclick="vht_calc_metabolic_age_calculator('<?php echo esc_js($uid); ?>')"><?php esc_html_e('Calculate', 'vitalhealth-tools'); ?></button>
    </form>
