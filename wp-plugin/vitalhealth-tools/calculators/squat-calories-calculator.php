...
$uid = 'vht_squat_calories_calculator_' . uniqid();
?>
<div class="vht-calculator" id="<?php echo esc_attr($uid); ?>" data-calculator="squat-calories-calculator">
    <h3 class="vht-calc-title"><?php esc_html_e('Squat Calories Calculator', 'vitalhealth-tools'); ?></h3>
    <form class="vht-calc-form" onsubmit="return false;">
        ...
        <div class="vht-field">
            <label for="<?php echo esc_attr($uid); ?>_reps"><?php esc_html_e('Number of Squats', 'vitalhealth-tools'); ?></label>
        ...
        <button type="button" class="vht-btn-calculate" onclick="vht_calc_squat_calories_calculator('<?php echo esc_js($uid); ?>')"><?php esc_html_e('Calculate', 'vitalhealth-tools'); ?></button>
    </form>
