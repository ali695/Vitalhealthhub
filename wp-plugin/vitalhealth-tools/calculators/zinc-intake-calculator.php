...
$uid = 'vht_zinc_intake_calculator_' . uniqid();
?>
<div class="vht-calculator" id="<?php echo esc_attr($uid); ?>" data-calculator="zinc-intake-calculator">
    <h3 class="vht-calc-title"><?php esc_html_e('Zinc Intake Calculator', 'vitalhealth-tools'); ?></h3>
    <form class="vht-calc-form" onsubmit="return false;">
        ...
        <button type="button" class="vht-btn-calculate" onclick="vht_calc_zinc_intake_calculator('<?php echo esc_js($uid); ?>')"><?php esc_html_e('Calculate', 'vitalhealth-tools'); ?></button>
    </form>
