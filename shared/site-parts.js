...
<div class="footer-logo"><a href="/"><img src="/images/logo.png" alt="VitalHealth Hub" class="footer-logo-img"></a></div>
...
<a href="https://www.facebook.com/AliHadi768" target="_blank" rel="noopener noreferrer" class="footer-social-btn facebook" title="Facebook"><svg width="16" height="16" viewBox="0 0 24 24" fill="#9ca3af"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg></a>
<a href="https://www.instagram.com/ali_haiderseo/" target="_blank" rel="noopener noreferrer" class="footer-social-btn instagram" title="Instagram"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="#9ca3af"/></svg></a>
</div>
</div>
<div class="footer-col">
<h4>Popular Tools</h4>
...
<div><p style="color:#fff;font-weight:600;font-size:14px;margin:0;">VitalHealth Assistant</p><p style="color:#a7f3d0;font-size:11px;margin:0;">🟢 Online — Health Q&A Bot</p></div>
</div>
...
module.exports = { SITE, SITE_NAME, NAV, FOOTER, CHATBOT, BTT, head };
