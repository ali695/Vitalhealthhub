module.exports = [
  ...
  // ─── HEALTH & TRACKING ─────────────────────────────────────────────────────
  {
    ...
    categorySlug: 'health',
    icon: '<svg viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="16" stroke="#2d6a4f" stroke-width="2.5"/><path d="M16 24l6 6 10-12" stroke="#52b788" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    desc: 'Build lasting habits with streak tracking, weekly views, and progress analytics — all saved privately in your browser.',
    type: 'habit-tracker',
    metaTitle: 'Habit Tracker – Build Streaks & Stay Consistent | VitalHealth Hub',
    metaDesc: 'Struggling to make habits stick? Track daily habits with streak counting, weekly views, and progress analytics. No account needed — your data stays private in your browser.',
  ...
  },
  {
    ...
    category: 'Health & Tracking',
    categorySlug: 'health',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M36 26c0 8-6 14-14 14S8 34 8 26s6-14 14-14c-4 2-6 6-6 10s4 10 10 10c4 0 7-2 10-6z" stroke="#2d6a4f" stroke-width="2.5"/><circle cx="37" cy="11" r="2.5" fill="#f4a261"/><circle cx="42" cy="19" r="1.5" fill="#f4a261"/></svg>',
    desc: 'Log your sleep, get a quality score, and discover patterns in your sleep history with personalised insights.',
    type: 'sleep-tracker',
    metaTitle: 'Sleep Tracker – Log Sleep & Discover Your Patterns | VitalHealth Hub',
    metaDesc: 'Waking up tired without knowing why? Log your sleep duration and quality, get a personalized sleep score, and spot the patterns affecting your rest. No sign-up required.',
  ...
  },
  {
    ...
    category: 'Health & Tracking',
    categorySlug: 'health',
    icon: '<svg viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="16" stroke="#2d6a4f" stroke-width="2.5"/><circle cx="18" cy="20" r="2" fill="#2d6a4f"/><circle cx="30" cy="20" r="2" fill="#2d6a4f"/><path d="M17 30c2 3 12 3 14 0" stroke="#52b788" stroke-width="2.5" stroke-linecap="round"/></svg>',
    desc: 'Log your daily mood, spot emotional patterns in your calendar view, and track your mental wellness over time.',
    type: 'mood-tracker',
    metaTitle: 'Mood Tracker – Log Daily Mood & Spot Emotional Patterns | VitalHealth Hub',
    metaDesc: 'Emotions have patterns — and tracking them reveals powerful insights. Log your daily mood, visualize trends with a color-coded calendar, and understand what shapes your mental wellness.',
  ...
  },
  {
    ...
    category: 'Health & Tracking',
    categorySlug: 'health',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M14 14c0-2.2 1.8-4 4-4h6a4 4 0 0 1 0 8h-2a4 4 0 0 0 0 8h6a4 4 0 0 1 0 8h-6a4 4 0 0 1-4-4" stroke="#2d6a4f" stroke-width="2.5" stroke-linecap="round"/><path d="M12 38h24" stroke="#52b788" stroke-width="2" stroke-linecap="round"/></svg>',
    ...
    type: 'step-tracker',
    metaTitle: 'Step Tracker – Log Steps & Hit Your Daily Goal | VitalHealth Hub',
    metaDesc: 'Turn your step count into a consistent habit. Log daily steps, track your goal with an animated progress ring, and view your 7-day activity chart. No app download needed.',
  ...
  },
  {
    ...
    category: 'Health & Tracking',
    categorySlug: 'health',
    icon: '<svg viewBox="0 0 48 48" fill="none"><rect x="6" y="8" width="36" height="32" rx="4" stroke="#2d6a4f" stroke-width="2.5"/><path d="M6 20h36" stroke="#2d6a4f" stroke-width="2"/><path d="M14 30h4M22 26h4M30 28h4" stroke="#52b788" stroke-width="2.5" stroke-linecap="round"/></svg>',
    desc: 'Your personal health command centre — see sleep, mood, steps, and habit streaks all in one place.',
    type: 'health-dashboard',
    metaTitle: 'Health Dashboard – All Your Health Metrics in One Place | VitalHealth Hub',
    metaDesc: 'Stop checking trackers one by one. See your sleep scores, mood trends, daily steps, and habit streaks all in one personal health dashboard. Your complete wellness picture at a glance.',
  ...
  // ─── PRODUCTIVITY ──────────────────────────────────────────────────────────
  {
    ...
    icon: '<svg viewBox="0 0 48 48" fill="none"><rect x="8" y="10" width="32" height="32" rx="4" stroke="#2d6a4f" stroke-width="2.5"/><path d="M8 20h32" stroke="#2d6a4f" stroke-width="2"/><path d="M16 6v8M32 6v8" stroke="#52b788" stroke-width="2" stroke-linecap="round"/><path d="M16 28h16M16 34h10" stroke="#2d6a4f" stroke-width="2" stroke-linecap="round"/></svg>',
    desc: 'Plan your day with time-blocked tasks, priority levels, and a clean checklist that auto-saves to your browser.',
    type: 'daily-planner',
    metaTitle: 'Daily Planner – Plan Your Day with Time Blocks | VitalHealth Hub',
    metaDesc: 'Unfocused days lead to wasted potential. Plan tasks with time blocks and priority levels, check them off as you go, and auto-save your day. Productivity built into your browser.',
  ...
  },
  {
    ...
    category: 'Productivity',
    categorySlug: 'productivity',
    icon: '<svg viewBox="0 0 48 48" fill="none"><circle cx="24" cy="26" r="16" stroke="#2d6a4f" stroke-width="2.5"/><path d="M24 14v12l7 4" stroke="#52b788" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 6h12M24 6v4" stroke="#2d6a4f" stroke-width="2" stroke-linecap="round"/></svg>',
    desc: 'Boost deep focus with a Pomodoro timer. Customisable work and break intervals with session tracking.',
    type: 'focus-timer',
    metaTitle: 'Focus Timer – Deep Work Sessions with Pomodoro | VitalHealth Hub',
    metaDesc: 'Distraction is the enemy of results. Use our Pomodoro focus timer with customizable work and break intervals to build genuine deep focus. No sign-up — start your session in seconds.',
  ...
  },
  {
    ...
    category: 'Productivity',
    categorySlug: 'productivity',
    icon: '<svg viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="16" stroke="#2d6a4f" stroke-width="2.5"/><circle cx="24" cy="24" r="8" stroke="#52b788" stroke-width="2"/><circle cx="24" cy="24" r="3" fill="#2d6a4f"/></svg>',
    desc: 'Set measurable goals, update your progress, and watch your progress bars fill as you move toward each target.',
    type: 'goal-tracker',
    metaTitle: 'Goal Tracker – Track Progress Toward Any Goal | VitalHealth Hub',
    metaDesc: 'Vague goals produce vague results. Set measurable targets, update your progress, and watch goal bars fill as you close in on every target. All saved privately in your browser.',
  ...
  // ─── TEXT & CONTENT ────────────────────────────────────────────────────────
  {
    ...
    categorySlug: 'text',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M10 8h28a2 2 0 0 1 2 2v28a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2z" stroke="#2d6a4f" stroke-width="2.5"/><path d="M16 18h16M16 24h16M16 30h10" stroke="#52b788" stroke-width="2" stroke-linecap="round"/></svg>',
    ...
    metaTitle: 'Text Analyzer – Word Count, Readability & Keywords | VitalHealth Hub',
    metaDesc: 'Get deep text insights in real time. Analyze word count, readability score, reading time, keyword density, and sentence stats instantly as you type. Completely private — no uploads.',
  ...
  },
  {
    ...
    category: 'Text & Content',
    categorySlug: 'text',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M8 14h32M8 24h24M8 34h18" stroke="#2d6a4f" stroke-width="2.5" stroke-linecap="round"/><circle cx="38" cy="34" r="6" stroke="#52b788" stroke-width="2"/><path d="M36 34l4-2" stroke="#52b788" stroke-width="1.5" stroke-linecap="round"/></svg>',
    ...
    metaTitle: 'Headline Analyzer – Score Your Headlines for CTR | VitalHealth Hub',
    metaDesc: 'A weak headline kills clicks before they happen. Score your headline for power words, emotional language, SEO length, and engagement potential. Get actionable improvement suggestions.',
  ...
  },
  {
    ...
    category: 'Text & Content',
    categorySlug: 'text',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M24 8c-6 0-10 4-10 10 0 4 2 7 6 9v5h8v-5c4-2 6-5 6-9 0-6-4-10-10-10z" stroke="#2d6a4f" stroke-width="2.5"/><path d="M20 32h8" stroke="#52b788" stroke-width="2" stroke-linecap="round"/><path d="M20 36h8" stroke="#52b788" stroke-width="2" stroke-linecap="round"/></svg>',
    ...
    metaTitle: 'Health Content Idea Generator – Instant Blog Ideas | VitalHealth Hub',
    metaDesc: 'Running out of content ideas? Generate targeted blog post ideas, social media angles, and FAQ topics for any health subject in seconds. Free, fast, and no sign-up required.',
  ...
  // ─── UTILITY TOOLS (Minimal) ──────────────────────────────────────────────
  {
    ...
    icon: '<svg viewBox="0 0 48 48" fill="none"><rect x="8" y="8" width="32" height="32" rx="4" stroke="#2d6a4f" stroke-width="2.5"/><path d="M24 18v12M18 28l6 6 6-6" stroke="#52b788" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    desc: 'Compress and reduce image file size without visible quality loss. No upload required.',
    type: 'image-compressor',
    metaTitle: 'Image Compressor – Reduce File Size Instantly | VitalHealth Hub',
    metaDesc: 'Large images slow down websites and waste storage. Compress JPG, PNG, and WebP images instantly with no visible quality loss. Runs entirely in your browser — no uploads ever.',
  ...
  },
  {
    ...
    category: 'Utility Tools',
    categorySlug: 'utility',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M16 10h-6a2 2 0 0 0-2 2v24a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2v-6" stroke="#2d6a4f" stroke-width="2.5" stroke-linecap="round"/><path d="M28 8h12v12" stroke="#52b788" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M40 8L24 24" stroke="#52b788" stroke-width="2" stroke-linecap="round"/></svg>',
    desc: 'Convert any image to JPG, PNG, or WebP format instantly in your browser. No upload required.',
    type: 'image-converter',
    metaTitle: 'Image Converter – Convert to JPG, PNG & WebP | VitalHealth Hub',
    metaDesc: 'Wrong image format slowing you down? Convert between JPG, PNG, and WebP instantly in your browser. No server uploads, no account — fast, private, and completely free.',
  ...
  },
  {
    ...
    category: 'Utility Tools',
    categorySlug: 'utility',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M12 6h14l8 8v28H12V6z" stroke="#2d6a4f" stroke-width="2.5"/><path d="M26 6v8h8" stroke="#2d6a4f" stroke-width="2"/><path d="M32 26h-6M32 32h-6M32 20h-6" stroke="#52b788" stroke-width="2" stroke-linecap="round"/></svg>',
    desc: 'Combine multiple PDF files into one document. Drag, drop, order, and merge — no upload required.',
    type: 'pdf-merge',
    metaTitle: 'PDF Merge Tool – Combine PDF Files Instantly | VitalHealth Hub',
    metaDesc: 'Juggling multiple PDF files? Merge them into one clean document in seconds. Completely free, no sign-up, and processed entirely in your browser — your files never leave your device.',
  ...
  },
  {
    ...
    category: 'Utility Tools',
    categorySlug: 'utility',
    icon: '<svg viewBox="0 0 48 48" fill="none"><path d="M10 6h14l6 6v8M10 6v36h18" stroke="#2d6a4f" stroke-width="2.5" stroke-linecap="round"/><path d="M24 6v6h6" stroke="#2d6a4f" stroke-width="2"/><path d="M30 28l8-8M30 28h6M30 28v-6" stroke="#52b788" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    desc: 'Extract specific pages from a PDF by entering a page range. No upload, no account required.',
    type: 'pdf-split',
    metaTitle: 'PDF Splitter – Extract Exact Pages from Any PDF | VitalHealth Hub',
    metaDesc: 'Need just a few pages from a large PDF? Enter your page range and extract them instantly. Free online PDF splitter — no uploads, no sign-up, runs privately in your browser.',
